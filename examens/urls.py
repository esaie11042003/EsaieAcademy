...
urlpatterns = [
    path("", views.liste_examens, name="liste_examens"),
    path("ajouter/", views.ajouter_epreuve, name="ajouter_epreuve"),
    path("gerer/", views.gerer_examens, name="gerer_examens"),
    ...
    path("corbeille/", views.corbeille_examens, name="corbeille_examens"),
